...
url=[]
url.append('https://www.amazon.in/gp/bestsellers/books?ie=UTF8&pg=1')
url.append('https://www.amazon.in/gp/bestsellers/books?ie=UTF8&pg=2')
url.append('https://www.amazon.in/gp/bestsellers/books?ie=UTF8&pg=3')
url.append('https://www.amazon.in/gp/bestsellers/books?ie=UTF8&pg=4')
url.append('https://www.amazon.in/gp/bestsellers/books?ie=UTF8&pg=5')


filename= "./output/in_book.csv"
...
for j in url:
        ...
        for i in range(20):
                ...
                url=containers[i].findAll("a",{"class":"a-link-normal"})
                urlprint="https://www.amazon.in" + url[0]["href"]
